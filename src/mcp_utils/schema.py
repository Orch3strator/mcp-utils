...
class AgentResource(BaseModel):
    ...
    blob: str = Field(..., description="Raw JSON payload serialized as string (unencrypted)")
    ...
    encryption_algorithm: str | None = Field(None, description="Encryption method used (e.g., AES256-GCM)")
